...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        # She starts typing some text dor the new item and the error disappears
        ...
        self.get_item_input_box().send_keys(Keys.ENTER)
        self._wait_for_row_in_list_table('1: Buy milk')
        self._wait_for_row_in_list_table('2: Make tea')
    ...
    def test_cannot_add_duplicate_items(self):
        ...
        self.get_item_input_box().send_keys(Keys.ENTER)
        self._wait_for_row_in_list_table('1: Buy wellies')
        ...
        self.wait_for(lambda: self.assertEqual(
            ...
            "Item with this Text already exists."
        ))
